...
API_INLINE scalar_t interp1D(scalar_t v1, scalar_t v2, scalar_t x)
{
    return v1*(1 - x) + v2*x;
}

template<typename scalar_t>
API_INLINE scalar_t interp1D_dx(scalar_t v1, scalar_t v2)
{
    return v2 - v1;
}

template<typename scalar_t>
API_INLINE scalar_t interp2D(scalar_t v1, scalar_t v2, scalar_t v3, scalar_t v4, scalar_t x, scalar_t y)
{
    return interp1D(interp1D(v1, v2, x), interp1D(v3, v4, x), y);
}

template<typename scalar_t>
API_INLINE scalar_t interp2D_dx(scalar_t v1, scalar_t v2, scalar_t v3, scalar_t v4, scalar_t y)
{
    return interp1D(interp1D_dx(v1, v3), interp1D_dx(v2, v4), y);
}

template<typename scalar_t>
API_INLINE scalar_t interp2D_dy(scalar_t v1, scalar_t v2, scalar_t v3, scalar_t v4, scalar_t x)
{
